...
python plugins/kintone-space-writer/scripts/kintone_article_bridge.py mark-ready --article drafts/article-v001.rich.json --assets-root assets --target test-news
